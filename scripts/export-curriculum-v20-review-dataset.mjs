...
await writeFile('v20-review-export.json', JSON.stringify({ version: 'v20-editorial-review-export-2026-08-18', rows }, null, 2), 'utf8')
console.log(`[v20-export] wrote ${rows.length} learner-facing V20 editorial unit records to v20-review-export.json`)
