...
import { getCachedTextbookUnitContentV20Final } from './curriculum-textbook-v20-final'
...
// V20 final rebuilds from the validated V18 baseline, so its internal request for V18
// must resolve to the legacy validated unit rather than recursively re-entering V20.
// Static QA trace: curriculum-textbook-v20-final wraps pass1 + V20 runtime.
...
export function getTextbookUnitContentV18(unitId: string) {
  ...
  try {
    return getCachedTextbookUnitContentV20Final(unitId)
  } finally {
