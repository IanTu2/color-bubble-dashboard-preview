 ...
 * V18 remains available in curriculum-pedagogy-v18-final.ts as the historical
 * concrete baseline used by V21 and by regression audits. Student-facing code
 * can keep the existing import path while receiving V21 content.
 */
